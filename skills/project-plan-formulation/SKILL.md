...
6. **If "Targeted update":** Load `references/invocation-modes.md` and follow the Targeted Update flow.
...
- Check for invocation modifiers (`--section` flag, supplemental context)
- If `--section` flag present: Load `references/invocation-modes.md` and follow the Section Targeting flow
- If supplemental context provided: Load `references/invocation-modes.md` and follow the Supplemental Context flow
- Otherwise: Proceed directly to Section 1
...
- Invocation modes: `references/invocation-modes.md` (section targeting, targeted update, supplemental context)
